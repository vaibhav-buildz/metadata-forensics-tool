import { IconCamera, IconFileDescription, IconRulerMeasure, IconDeviceDesktop } from '@tabler/icons-react';
...
export default function MetadataCard({ metadata }) {
  ...
  return (
    <div className="bg-[#FFFFFF] rounded-xl p-6 shadow-sm border border-slate-200 border-l-4 border-l-[#2563EB] hover:shadow-md hover:-translate-y-[2px] transition-all duration-300 ease-out">
      
      <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
        <div className="p-2 bg-blue-50 text-[#2563EB] rounded-lg">
          <IconCamera size={24} stroke={1.5} />
        </div>
      ...
      <div className="space-y-6 text-[15px] text-[#1F2937]">
        ...
        {/* File Info Section */}
        <div>
          <h3 className="font-medium text-[#9CA3AF] text-[12px] uppercase tracking-wider mb-3 flex items-center gap-2">
        ...
        <div>
          <h3 className="font-medium text-[#9CA3AF] text-[12px] uppercase tracking-wider mb-3 flex items-center gap-2">
            <IconDeviceDesktop size={16} className="text-[#2563EB]" />
            Camera Information
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
